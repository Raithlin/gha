...
func ghaCapabilities() *model.Capabilities {
	return &model.Capabilities{
		...
		Commands: []model.Capability{
			...
			{Command: "agent install", Status: "available", ReadOnly: false, Notes: "Detects configured supported harnesses and installs bundled gha skills and guidance; --agent selects harnesses explicitly, --binary-only skips setup, and --dry-run previews without writing."},
			...
			{Command: "pr prepare", Status: "available", ReadOnly: true, Formats: []string{"text", "json", "yaml"}, SchemaVersion: model.PullRequestPreparationSchemaVersion, Notes: "Drafts a title and description from bounded local commits and changed files; reports source signals and provider preflight."},
			{Command: "pr create", Status: "available", ReadOnly: false, Formats: []string{"text", "json", "yaml"}, SchemaVersion: model.PullRequestPreparationSchemaVersion, Notes: "Runs the pull request preflight; --dry-run previews without creating."},
			...
			{Command: "branches", Status: "available", ReadOnly: false, Formats: []string{"text", "json", "yaml"}, SchemaVersion: model.BranchInventorySchemaVersion, Notes: "Bounded branch inventory; origin refresh is explicit and --dry-run previews the fetch."},
			...
			{Command: "branch create <name>", Status: "available", ReadOnly: false, Formats: []string{"text", "json", "yaml"}, SchemaVersion: model.BranchMutationSchemaVersion, Notes: "Creates locally; --publish also publishes to origin; --dry-run previews without writing."},
			...
			{Command: "branch rename <old> <new>", Status: "available", ReadOnly: false, Formats: []string{"text", "json", "yaml"}, SchemaVersion: model.BranchMutationSchemaVersion, Notes: "Renames locally; --origin also renames on origin after safety checks; --dry-run previews without writing."},
			{Command: "branch delete <name>", Status: "available", ReadOnly: false, Formats: []string{"text", "json", "yaml"}, SchemaVersion: model.BranchMutationSchemaVersion, Notes: "Requires explicit local/origin target; --force overrides documented safety guardrails; --dry-run previews without writing."},
			{Command: "tag publish <name>", Status: "available", ReadOnly: false, Formats: []string{"text", "json", "yaml"}, SchemaVersion: model.TagPublicationSchemaVersion, Notes: "Creates a tag at a selected commit and pushes that exact ref; --dry-run previews without writing."},
			...
			{Command: "release publish <version>", Status: "available", ReadOnly: false, Formats: []string{"text", "json", "yaml"}, SchemaVersion: release.SchemaVersion, Notes: "Preflights the default-branch commit, tags, checks, release workflow, and opted-in reviewed notes; --dry-run previews without publishing."},
